    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Home')}>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Manutencao')}>
              <ListItemButton
                sx={[
                  {
                    minHeight: 48,
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Viaturas')}>
              <ListItemButton
                sx={[
                  {
                    minHeight: 48,
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/Motoristas')}>
              <ListItemButton
                sx={[
                  {
                    minHeight: 48,
        ...
        <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>[logout(), navigate('/')]}>
              <ListItemButton
                sx={[
                  {
                    minHeight: 48,
